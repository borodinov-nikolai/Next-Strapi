...
async function POST(request) {
    ...
    try {
        ...
        const { data } = await serverConfig/* $apiServer_CMS */.u.post("/auth/local", {
            identifier,
            password
        });
        return new Response(JSON.stringify(data), {
            status: 200,
            headers: {
                "Set-Cookie": `token=${data.jwt};path=/;httpOnly=true;samesite=strict`
            }
        });
    } catch (error) {
...
;// CONCATENATED MODULE: ./node_modules/next/dist/build/webpack/loaders/next-app-loader.js?page=%2Fapi%2Fauth%2Flogin%2Froute&name=app%2Fapi%2Fauth%2Flogin%2Froute&pagePath=private-next-app-dir%2Fapi%2Fauth%2Flogin%2Froute.ts&appDir=C%3A%5CUsers%5CNikolai%5CDesktop%5CProjects%5CNext-Strapi%5Cnext%5Csrc%5Capp&appPaths=%2Fapi%2Fauth%2Flogin%2Froute&pageExtensions=tsx&pageExtensions=ts&pageExtensions=jsx&pageExtensions=js&basePath=&assetPrefix=&nextConfigOutput=&preferredRegion=&middlewareConfig=e30%3D!
...
var __webpack_exports__ = __webpack_require__.X(0, [326,527,501], () => (__webpack_exec__(6575)));
